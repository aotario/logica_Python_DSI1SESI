...
print("A temperatura medida é 23.5°C")
...
# e mostre seu tipo.
população = 8_000_000_000
print(type(população))
print("A população mundial é de 8 bilhões de pessoas")
